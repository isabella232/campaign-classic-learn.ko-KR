---
title: 프로필 만들기 및 관리
description: Adobe Campaign Classic의 프로파일 개념을 파악합니다. 프로필 데이터에 액세스하고, 프로필을 정렬 및 필터링하고, 프로필을 수동으로 만들고 관리하는 방법을 알아봅니다. 또한 이 비디오에서는 Adobe Campaign Classic의 개인 정보 보호 규정(GDPR) 준수 및 CCPA(California Consumer Privacy Act)에 대해서도 설명합니다.
feature: Profiles
topics: null
kt: 5081
thumbnail: 35611.jpg
...
Adobe Campaign Classic의 프로파일 개념을 파악합니다. 프로필 데이터에 액세스하고, 프로필을 정렬 및 필터링하고, 프로필을 수동으로 만들고 관리하는 방법을 알아봅니다.
