...
+ 시작 {#getting-started}
   ...
   + [워크플로우에서 프로필 타깃팅하기](/help/getting-started/targeting-profiles-in-a-workflow.md)
...
+ 메시지 보내기{#sending-messages}
   + 이메일 채널{#email-channel}
      ...
      + [증명 자료 전송 및 유효성 검사](/help/sending-messages/email-channel/send-and-validate-proofs.md)
...
+ 캠페인 오케스트레이션 {#orchestration}
   ...
   + [멀티채널 및 크로스 채널 캠페인 소개](/help/orchestrating-campaigns/introduction-to-cross-and-multi-channel-campaigns.md)
...
+ 워크플로우 {#automating-with-workflows}로 자동화
   + [워크플로우 만들기](/help/automating-with-workflows/creating-a-workflow.md)
   + [타기팅 워크플로우 만들기](/help/automating-with-workflows/creating-a-targeting-workflow.md)
...
+ [Adobe Campaign 문제 해결](https://experienceleague.adobe.com/docs/campaign-classic-learn/troubleshooting/overview.html)
