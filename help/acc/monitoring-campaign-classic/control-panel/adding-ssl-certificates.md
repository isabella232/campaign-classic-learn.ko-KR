...
Adobe Campaign Campaign 컨트롤 패널을 사용하면 하위 도메인 보안을 위해 SSL 인증서를 추가할 수 있습니다.
...
SSL 인증서를 구매하려면 CSR(Certificate Signing Request)이 필요합니다. 인스턴스 및 보안을 설정할 하위 도메인에 대해 생성되어야 합니다.
...
CSR을 받은 후에는 조직에서 승인한 인증 기관에서 SSL 인증서를 구입해야 합니다.

### 3. SSL 인증서 설치

SSL 인증서를 얻게 되면 보안을 설정할 하위 도메인에 대해 설치해야 합니다.

아래 비디오에서는 Campaign 컨트롤 패널에서 SSL 인증서를 설치하는 방법을 설명합니다.
